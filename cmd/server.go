	...
	Run: func(cmd *cobra.Command, args []string) {
		fx.New(
			...
			fx.Provide(
				...
				user.NewUserUnitService,
				user.NewUserUnitHandler,
				credential.NewGormCredentialRepository,
				credential.NewGormCredentialTypeRepository,
				credential.NewCredentialTypeService,
				credential.NewCredentialTypeHandler,
				credential.NewGormCredentialIssuerOrganizationRepository,
				credential.NewCredentialIssuerOrganizationService,
				credential.NewCredentialIssuerOrganizationHandler,
				credential.NewGormCompetencyRepository,
				credential.NewGormCompetencyCredentialRepository,
				credential.NewCompetencyService,
				credential.NewCompetencyHandler,
